/* package com.ecommerce.core.springfox;
...
import com.ecommerce.api.openapi.model.PageableModelOpenApi;
import com.ecommerce.api.openapi.model.PedidosResumoModelOpenApi;
  ...
  private List<Response> globalGetResponseMessages() {
    return Arrays.asList(
      ...
      new ResponseBuilder()
        ...
        .description(
          "Recurso não possui representação que pode ser aceita pelo consumidor"
        )
        .build()
    );
  }
                  ...
                  k ->
                    k.qualifiedModelName(
                      q ->
                        q
                          .name("Problema")
                          .namespace("com.api.delivery.api.exceptionhandler")
                    )
                )
            )
      );
  ...
  private ApiInfo apiInfo() {
    return new ApiInfoBuilder()
      ...
      .contact(
        new Contact(
          "Gabriel Gonçalves",
          "https://github.com/ggoncalvesdev",
          "gabrieljgoncalves03@hotmail.com"
        )
      )
      .build();
  }
