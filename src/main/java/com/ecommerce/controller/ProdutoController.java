...
public class ProdutoController {
  ...
  @ApiResponses(
    value = {
      ...
      @ApiResponse(
        responseCode = "400",
        description = "Imagem não foi selecionada"
      ),
      ...
      @ApiResponse(
        responseCode = "422",
        description = "Categoria não encontrada ou arquivo invalido"
      ),
      @ApiResponse(
        responseCode = "404",
  ...
  public ResponseEntity<ProdutoDTO> insert(
    @Valid @RequestPart("produto") String produtoTxt,
  ...
  public ResponseEntity<ProdutoDTO> update(
    ...
    @RequestBody ProdutoDTO productDto
  ) {
